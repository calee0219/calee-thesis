...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \node[rectangle,draw,right=of tx_thread,align=center,font={\tiny},xshift=-2em,double,minimum width=4em] (rules) {Packet\\Pool};
        \node[thread] (rx_thread) at ($(upfu_rx) + (0,-1.3)$) {RX\\Thread};
        \node[rectangle,draw,right=of rx_thread,align=center,font={\tiny},xshift=-2em,double] (rules) {Rules\\Table};
