\documentclass[zh,watermark,final]{thesis}  % draft mode (default)
...
\usetikzlibrary{arrows,arrows.meta,calc,shapes,chains,backgrounds,fit}
\usepackage[inline]{enumitem}
%\usepackage{pdfcomment}
\usepackage{xspace}
\usepackage{xltabular}    % Table style
...
\newcommand{\LHCN}{LH5GC\xspace}
\renewcommand\_{\textunderscore\allowbreak}
%\newcommand{\cnote}[1]{{\color{red}[calee: #1]}}
%\newcommand{\cnote}[1]{{\todo[author=calee]{#1 \pdfcomment[author={calee}]{#1} }}}
% Keywords command
